...
public class MemoryCompany {
    ...
    private static final String CREATE_TABLE = "CREATE TABLE company(Companyname varchar GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY , " +
